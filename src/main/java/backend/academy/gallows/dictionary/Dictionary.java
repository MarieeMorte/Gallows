    ...
    private static void initializeDictionary() {
        ...
        addWords(Difficulties.HARD, Themes.FRUITS,
            List.of(new WordWithHint("бергамот",
                ...
                new WordWithHint("виноград",
                    "сладкие ягоды, которые могут быть зелёными, красными или чёрными, часто используются для производства вина."),
